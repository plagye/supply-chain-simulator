...
- **Products (10):** D-101..D-303 (Sparrow-S1/Pro, Falcon-X, Courier-M/L, Surveyor-300/500, Titan-Hauler, Agri-Sprayer, Sky-Crane). See `data/products.json`.
...
- **Master data:** `data/suppliers.json`, `parts.json`, `bom.json`, `products.json`, `customers.json`, `facilities.json`, `routes.json`, `inventory.json`, `production_schedule.json`.
